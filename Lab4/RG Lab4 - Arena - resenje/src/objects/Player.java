...
//            game.moveParallelCameraVertical(true);
//        } else if (e.getCode() == KeyCode.DOWN && e.getEventType() == KeyEvent.KEY_PRESSED) {
//            game.moveParallelCameraVertical(false);
//        } else if (e.getCode() == KeyCode.RIGHT && e.getEventType() == KeyEvent.KEY_PRESSED) {
//            game.moveParallelCameraHorizontal(true);
//        } else if (e.getCode() == KeyCode.LEFT && e.getEventType() == KeyEvent.KEY_PRESSED) {
//            game.moveParallelCameraHorizontal(false);
//        }
